...
import { ShoppingCart, Lock, CreditCard, Truck, Gift, AlertCircle, Check, MapPinned } from 'lucide-react';
...
const CheckoutPage: React.FC = () => {
  ...
  const cartItems: CartItem[] = [
    ...
    { id: '2', name: 'Smart Watch Series 8', price: 399.99, quantity: 1, image: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=100&h=100&fit=crop' }
  ];
                        ...
                        <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                          <div className="flex items-center space-x-2">
                            ...
                            <p className="text-sm text-blue-700">
                              Card payment will be processed securely through Stripe on the next step.
                            </p>
                          </div>
                        </div>
                      )}
              ...
              {currentStep === 3 && (
                <div className="space-y-6">
                  <div className="flex items-center space-x-3 mb-6">
                    ...
                    <h4 className="text-xl font-semibold text-gray-900">Review Your Order</h4>
                  </div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-6">
                    ...
                    <p className="text-gray-600">
                      {paymentMethod === 'card' ? 'Credit/Debit Card (via Stripe)' : 'PayPal'}
                    </p>
                  </div>
