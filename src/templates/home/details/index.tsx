...
const Details = () => {
  ...
  return (
    <section className="py-24 bg-gray-50">
      <p className="uppercase tracking-[2px] text-lg text-center">Technology</p>
      ...
      <div className="container grid md:grid-cols-3 gap-10 relative z-10">
        {/* Card 1 - Text below */}
        <div className="bg-white rounded-3xl p-6 pt-0 flex flex-col items-center relative group">
          <Image
            src={img1}
            alt="shoe"
            height={400}
          ...
          {/* SVG Line */}
          <svg
            className="absolute translate-y-60 left-1/2 transform -translate-x-1/2"
            width="200"
            height="80"
            viewBox="0 0 200 80"
          >
            <path
              d="M 100 0 L 100 40 Q 100 50 110 50 L 140 50 Q 150 50 150 60 L 150 80"
        ...
        {/* Card 2 - Text above */}
        <div className="bg-white rounded-3xl p-6 pb-0 flex flex-col justify-between items-center relative group">
          {/* Text */}
