  export const DETAILS_DATA = [
    {
      ...
      bg: "bg-teal-50",
      svgPath:
        "M 100 0 L 100 40 Q 100 50 110 50 L 140 50 Q 150 50 150 60 L 150 120",
      textPosition: "bottom",
      imageWidth: "80%",
    ...
    
    {
      ...
      bg: "bg-cyan-50",
      svgPath:
        "M 100 120 L 100 40 Q 100 30 110 30 L 140 30 Q 150 30 150 20 L 150 0",
      textPosition: "top",
      imageWidth: "85%",
    ...
    },
    {
      ...
      bg: "bg-rose-50",
      svgPath: "M 100 200 L 100 40 Q 100 30 110 30 L 180 30",
      textPosition: "side",
      imageWidth: "70%",
